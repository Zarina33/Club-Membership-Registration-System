...
<section class="header" style="background-image: url(../images/rm373batch2-05.jpg);  background-size: cover;">
   ...
   <nav class="navbarr">
      ...
      <a href="register/show.php">Show users</a>
      <a href= "">|</a>
      ...
      <a href= " ">
      <a href= " ">
      <a><?php echo $_SESSION['admin_name'] ?></a>
      <a href="">    </a>
      <a href= "a">
     </a>
<a href= " ">
...
<section class="footer" style="background-image: url(../images/llogo.jpg); background-size: cover;">
   ...
   <div class="box-container">
      ...
      <div class="box">
         <h3>Quick Links</h3>
        <a href="original_todo/todo.php"> <i class="fas fa-angle-right"></i>To Do List</a>
         <a href="../home.php"> <i class="fas fa-angle-right"></i>Facts</a>
         <a href="../about.php"> <i class="fas fa-angle-right"></i> Log Out</a>
      </div>
